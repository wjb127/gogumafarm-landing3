...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <img src="/korean-cute-animals-youtube.png" alt="유튜브 지트키 등장" className="w-full rounded-lg" />
            </div>
            <div>
              <div className="mb-4">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="relative">
                <div className="absolute -top-2 -left-2 z-10">
                  <div className="bg-yellow-400 text-black px-3 py-1 rounded-full font-bold text-sm transform -rotate-12">
                    READ NOW!
                  </div>
                </div>
      ...
      {/* Footer */}
      <footer className="bg-yellow-300 py-16 relative">
